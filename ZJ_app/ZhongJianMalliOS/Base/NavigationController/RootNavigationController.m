...
//    [navBar setBarTintColor:[UIColor colorWithHexString:@"111111"]];//导航栏颜色
//    [navBar setTintColor:[UIColor colorWithHexString:@"5187e9"]];
//    [navBar setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor blueColor], NSFontAttributeName:[UIFont systemFontOfSize:18]}];
//
//    [navBar setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithHexString:@"ffffff"]] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
...
+ (void)setupNavBarTheme {
    ...
    textArrts[NSForegroundColorAttributeName] = [UIColor colorWithHexString:@"444444"];
    textArrts[NSFontAttributeName] = [UIFont systemFontOfSize:18];
    [navbar setTitleTextAttributes:textArrts];
