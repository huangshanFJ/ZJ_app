...
#define kLastSelection @"ZJSelectionArchive_%p"


@interface ZJSelectionCell : UITableViewCell
@property (nonatomic, strong) UIButton *selectionButton;
@property (nonatomic, strong) UILabel *descriptionLabel;
@end

@implementation ZJSelectionCell
...
@interface ZJSelectionView ()<UITableViewDelegate, UITableViewDataSource>
//Data
...
@implementation ZJSelectionView

+ (ZJSelectionView *_Nonnull)showWithTitle:(NSString *_Nonnull)title options:(NSArray *_Nonnull)optionsArray singleSelection:(BOOL)selection delegate:(id _Nonnull)delegate completionHandler:(CompleteSelection _Nonnull)handler{
    
    ZJSelectionView *view = [[ZJSelectionView alloc] initWithFrame:kAppWindow.bounds];
    ...
    [view.tableView registerClass:[ZJSelectionCell class] forCellReuseIdentifier:@"ZJSelectionCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ZJSelectionCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ZJSelectionCell"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ZJSelectionCell *cell = (ZJSelectionCell *)[tableView cellForRowAtIndexPath:indexPath];
...
- (void)showView:(ZJSelectionView *)view {
    view.bgView.alpha = 0;
...
- (void)closeView:(ZJSelectionView *)view {
