...
-(void)setupWithPasswordAlertViewType_default{
    ...
    self.bgView = [[UIView alloc]initWithFrame:CGRectMake(20, self.center.y-140, ScreenWidth-40, 200)];
    ...
    [cancleBtn setImage:[UIImage imageNamed:@"payment_close"] forState:UIControlStateNormal];
    ...
    for (int i = 0; i<6; i++) {
        ...
        UIView *dotView = [[UIView alloc] initWithFrame:CGRectMake(12.5, 10, 20, 20)];
        dotView.backgroundColor = [UIColor blackColor];
        dotView.layer.cornerRadius = 20 / 2.0f;
        dotView.clipsToBounds = YES;
        [imgView addSubview:dotView];
...
- (void)passwordNotSetting {
    self.tipsLalbe.text = @"未设置支付密码，请前往个人中心设置";
    self.tipsLalbe.hidden = NO;
}
